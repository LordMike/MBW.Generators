...
{
    [Fact]
    public void Overloads_DoNotInjectUsings()
    {
        (string? output, IReadOnlyList<Diagnostic> diags) =
            TestsHelper.RunHelper("""
                                  ...
                                  {
                                      [TransformOverload("kind", typeof(K), "{value}.ToString(\"G\", System.Globalization.CultureInfo.InvariantCulture)")]
        ...
        SyntaxHelper.Equal("""
                     ...
                     partial class U
                     {
                         public void M(global::K kind, bool retry)
                             => M(kind.ToString("G", System.Globalization.CultureInfo.InvariantCulture), retry);
