    ...
    public void Transform_ReplacesType_AndForwardsWithTemplate()
    {
        (string? output, IReadOnlyList<Diagnostic> diags) =
            TestsHelper.RunHelper("""
                                  ...
                                  {
                                      [TransformOverload("kind", typeof(Op), "{value}.ToString(\"G\", System.Globalization.CultureInfo.InvariantCulture)")]
    ...
    public void Transform_OnThisParameter_PreservesThisModifier()
    {
        (string? output, var diags) = TestsHelper
            .RunHelper("""
                       ...
                       {
                           [TransformOverload("s", typeof(System.ReadOnlySpan<char>), "{value}.ToString()")]
