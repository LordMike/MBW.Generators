...
public class NonTryMethodGeneratorTests
{
    ...
    public void GeneratesForPublicTryMethod()
    {
        ...
        const string expected = """
                                ...
                                """;
        (IReadOnlyDictionary<string, string> output, IReadOnlyList<Diagnostic> diags) =
            GeneratorTestHelper.Run<AutogenNonTryGenerator>(input, typeof(GenerateNonTryMethodAttribute));
        Assert.Empty(diags);
